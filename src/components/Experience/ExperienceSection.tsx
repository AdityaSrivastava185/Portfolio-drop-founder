            ...
            <div>
                <ul className="list-disc pl-5 space-y-7">
                    <div>
                        ...
                        <p className="italic text-sm text-balance">Frontend Developer Internship, Remote</p>
                    ...
                    <div>
                        ...
                        <p className="italic text-sm text-balance">Frontend Developer, Contractual Work, Remote</p>
                    ...
                    <div>
                        ...
                        <p className="italic text-sm text-balance">Frontend Developer</p>
